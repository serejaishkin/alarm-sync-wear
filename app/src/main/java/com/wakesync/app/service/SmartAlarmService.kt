...
import com.wakesync.app.data.actigraphy.ActigraphyEpoch
import com.wakesync.app.data.actigraphy.ActigraphySleepClassifier
import com.wakesync.app.data.actigraphy.SmartWakeDecision
import com.wakesync.app.data.actigraphy.SmartWakeDecisionEngine
import com.wakesync.app.data.actigraphy.SmartWakeDecisionResult
...
class SmartAlarmService : Service(), SensorEventListener {
    ...
    companion object {
        const val ACTION_START_SMART = "com.wakesync.app.SMART_ALARM_START"
