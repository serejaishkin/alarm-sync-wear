...
import com.wakesync.app.receiver.SnoozeCountdownReceiver
import com.wakesync.app.receiver.SnoozeReceiver
import com.wakesync.app.ui.alarmfiring.MorningBriefingActivity
import com.wakesync.app.util.AlarmPublicText
import com.wakesync.app.wear.WearNextAlarmBridge
import com.wakesync.app.sync.AlarmSyncCoordinator
...
class AlarmService : Service() {
    ...
    companion object {
        const val ACTION_START_ALARM = "com.wakesync.app.START_ALARM"
        const val ACTION_REMOTE_RINGING = "com.wakesync.app.REMOTE_RINGING"
        const val ACTION_SNOOZE = "com.wakesync.app.SNOOZE"
        const val ACTION_DISMISS = "com.wakesync.app.DISMISS"
        const val ACTION_SET_CHALLENGE_DUCKING =
            "com.wakesync.app.SET_CHALLENGE_DUCKING"
    ...
    private suspend fun startAlarm(alarmId: Long) {
        ...
        alarmSyncCoordinator.notifyWearAction(alarmId, com.wakesync.app.sync.AlarmSyncOperation.RINGING)
            ...
            autoSilenceJob = serviceScope.launch {
                ...
                if (missedAlarm != null) {
                    ...
                    withContext(NonCancellable) {
                        recordEvent(missedAlarm, com.wakesync.app.data.local.entity.AlarmEvent.ACTION_MISSED)
                        recordIncident(
        ...
        val flashingAllowed = com.wakesync.app.util.MotionPolicy.allowsMotion(
            this,
        ...
        if (alarm.guardianEnabled && alarm.guardianPhone.isNotBlank()) {
            ...
            val guardianRequest = OneTimeWorkRequestBuilder<com.wakesync.app.worker.GuardianWorker>()
