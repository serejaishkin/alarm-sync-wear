...
class AlarmClockApp : Application(), Configuration.Provider {
    ...
    interface AppEntryPoint {
        ...
        fun alarmRepository(): com.wakesync.app.data.repository.AlarmRepository
        fun alarmScheduler(): com.wakesync.app.domain.AlarmScheduler
    ...
    private suspend fun seedDefaultAlarm(ep: AppEntryPoint) {
        ...
        val alarm = com.wakesync.app.data.model.Alarm(
            hour = 6,
            minute = 0,
            label = "Wake Up",
            isEnabled = true,
